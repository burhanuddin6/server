...
class MyUserAdmin(EmailUserAdmin):
    '''
    This class was copy pasted from django-rest-authemail
    It seems that the purpose of this class has to do with the
    internals of the way User class is defined in authemail
    '''
    fieldsets = (
