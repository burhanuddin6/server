    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("resume_file", models.FileField(upload_to=ats.models.resume_filename)),
                (
                    "candidate_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="ats.candidate"
                    ),
                ),
                (
                    "job_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "job_screen_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="ats.jobscreen"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="ats.recruiter"
            ),
        ),
        migrations.AddField(
            model_name="job",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "candidate_job_screen_relation_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="ats.candidatejobscreenrelation",
                    ),
                ),
                (
                    "recruiter_id",
